...
def main(sample):
	...
	cv2.imwrite('/home/singular/img/9.jpeg',decoded)
	x=np.subtract(original_file_object,decoded)
	ratio=(original_file_size-compressed_file_size)/original_file_size
	print("Compression Ratio: "+str(ratio*100))
